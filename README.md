...
- **Pass headers**:
  ...
  | --------------- | ---------------------------------------------------- |
  | check-pass      | N/A (doesn't check compilation)                      |
  | build-pass      | N/A (doesn't check compilation / linking)            |
...
- **Fail headers**:
  ...
  | Rustc Directive | DejaGnu Directive                                                  |
  | --------------- | ------------------------------------------------------------------ |
  | check-fail      | N/A (doesn't check compilation)                                    |
  | build-fail      | N/A (doesn't check compilation during the codegen phase)           |
  | run-fail        | xfail (compilation should succeed, but running binary should fail) |
